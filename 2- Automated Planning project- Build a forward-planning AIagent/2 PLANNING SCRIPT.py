...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        # Get the effects of the two actions
        effectsA = self.children[actionA]
        effectsB = self.children[actionB]

        # Create a set of negated effects of actionB
        negatedEffectsB = set(~effect for effect in effectsB)

        # Check for intersection between effects of actionA and negated effects of actionB
        return bool(effectsA & negatedEffectsB)
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        # Get the preconditions (parents) and effects (children) of both actions
        preconditionsA = self.parents[actionA]
        preconditionsB = self.parents[actionB]
        effectsA = self.children[actionA]
        effectsB = self.children[actionB]

        # Create sets of negated effects
        negatedEffectsA = set(~effect for effect in effectsA)
        negatedEffectsB = set(~effect for effect in effectsB)

        # Check for interference:
    
        interferenceA = preconditionsA & negatedEffectsB
        interferenceB = preconditionsB & negatedEffectsA

        # Return True if either interference condition is met, otherwise False
        return bool(interferenceA) or bool(interferenceB)  
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any(self.parent_layer.is_mutex(action_a_pc, action_b_pc)
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        return all( self.parent_layer.is_mutex(lit_a_act, lit_b_act)
